...
let handler = async (m, { conn, usedPrefix }) => {
    ...
    if (m.isGroup) {
        try {
            ...
            const response = await axios.get('https://raw.githubusercontent.com/Elpapiema/Adiciones-para-AlyaBot-RaphtaliaBot-/refs/heads/main/video_json/fun-comer.json');
